...
BEGIN
  -- Auto-register any unseen publisher_keys from global_signals as tier-4 media
  ...
  WHERE canonical_source_name IS NOT NULL
    AND canonical_source_name NOT IN (SELECT publisher_key FROM source_authority_registry)
