  ...
  public: {
    Tables: {
      ...
      api_keys: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations_member_safe"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "api_keys_org_id_fkey"
      ...
      hypothesis_evaluations: {
        ...
        Relationships: [
          {
            foreignKeyName: "hypothesis_evaluations_hypothesis_id_fkey"
            columns: ["hypothesis_id"]
            isOneToOne: false
            referencedRelation: "intelligence_hypotheses"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      prediction_ledger: {
        Row: {
          ...
          method: string
          model_version: string
          outcome_knowable_at: string | null
          outcome_observed_at: string | null
          payload_canonical: Json | null
          payload_hash: string
          predicted_at: string
          ...
          subject_key: string
          subject_kind: string
          superseded_by_ledger_id: string | null
      ...
      prediction_ledger_outcomes: {
        ...
        Relationships: [
          {
            foreignKeyName: "prediction_ledger_outcomes_ledger_id_fkey"
            columns: ["ledger_id"]
            isOneToOne: true
            referencedRelation: "prediction_ledger"
            referencedColumns: ["id"]
      ...
      weak_signal_detections: {
        Row: {
          ...
          corroborating_evidence: Json
          corroborating_sources: number
          corroboration_quality: string
          created_at: string
          detected_at: string
          detected_on: string
          domain: string
    ...
    Views: {
      ...
      prediction_ledger_performance: {
        Row: {
          domain: string | null
          expired_unscored: number | null
          ...
          model_version: string | null
          open_awaiting_horizon: number | null
      ...
      weak_signal_quality: {
        Row: {
          ...
          domain_corroborated: number | null
    ...
    Functions: {
      ...
      evaluate_all_hypotheses: { Args: never; Returns: Json }
      ...
      evaluate_hypothesis: {
        Args: { p_history_days?: number; p_hypothesis_id: string }
        Returns: Json
      }
      ...
      normal_two_sided_p: { Args: { z: number }; Returns: number }
      ...
      prediction_ledger_canonical_payload: {
        Args: {
          p_domain: string
          p_features: Json
          p_hi: number
          ...
          p_outcome_knowable_at: string
          p_predicted_at: string
      ...
      realize_prediction_ledger: { Args: { p_limit?: number }; Returns: Json }
      ...
      review_weak_signal: {
        Args: { p_detection_id: string; p_notes?: string; p_verdict: string }
        Returns: Json
      }
      ...
      supersede_prediction_ledger_entry: {
        Args: {
          p_ledger_id: string
          p_new_hi?: number
          p_new_lo?: number
          p_new_probability?: number
          p_reason: string
        }
        Returns: Json
      }
